    ...
    <div className="map-page-container">
      ...
      <div className={`map-left-nav ${leftNavOpen ? 'open' : 'closed'}`}>
        ...
        <nav className="left-nav-content">
          <a href="/authority" className="left-nav-item">
            <Home className="w-5 h-5" />
            <span>Authority Dashboard</span>
          </a>
          <a href="/authority/verification" className="left-nav-item">
            <FileText className="w-5 h-5" />
            <span>Report & Verification</span>
          </a>
          <a href="/authority/tickets" className="left-nav-item">
            <FileText className="w-5 h-5" />
            <span>Tickets</span>
          </a>
          <a href="/authority/alerts" className="left-nav-item">
            <AlertTriangle className="w-5 h-5" />
            <span>Alert Management</span>
          </a>
          <a href="/authority/map" className="left-nav-item active">
          ...
          <a href="/authority/analytics" className="left-nav-item">
