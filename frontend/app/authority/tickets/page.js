...
const statusConfig = {
  ...
  resolved: { bg: 'bg-[#e8f4fc]', text: 'text-[#083a57]', icon: CheckCircle, label: 'Resolved' },
  closed: { bg: 'bg-gray-100', text: 'text-gray-600', icon: XCircle, label: 'Closed' }
};

export default function AuthorityTicketsPage() {
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-gradient-to-r from-[#0d4a6f] to-[#083a57] rounded-2xl shadow-lg p-6 text-white relative overflow-hidden">
          ...
          <div className="flex items-center justify-between relative z-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold">Authority Tickets</h1>
                <p className="text-[#9ecbec]">Manage and respond to hazard report tickets</p>
              </div>
            </div>
            <button
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <div className="bg-white rounded-xl p-4 border border-green-200 shadow-sm">
            ...
            <div className="text-2xl font-bold text-green-700 mt-1">{stats.open}</div>
          </div>
          <div className="bg-white rounded-xl p-4 border border-purple-200 shadow-sm">
            ...
            <div className="text-2xl font-bold text-purple-700 mt-1">{stats.in_progress}</div>
          </div>
          <div className="bg-white rounded-xl p-4 border border-[#9ecbec] shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-sm text-[#0d4a6f]">Resolved</span>
              <CheckCircle className="w-5 h-5 text-[#1a6b9a]" />
            </div>
            <div className="text-2xl font-semibold text-[#083a57] mt-1">{stats.resolved}</div>
          </div>
          <div className="bg-white rounded-xl p-4 border border-red-200 shadow-sm">
            ...
            <div className="text-2xl font-bold text-red-700 mt-1">{stats.overdue}</div>
          </div>
        </div>
            ...
            {filteredTickets.map((ticket) => {
              ...
              return (
                <div
                  ...
                  onClick={() => router.push(`/authority/tickets/${ticket.ticket_id}`)}
